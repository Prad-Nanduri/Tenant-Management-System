  ...
  return (
    <div className="flex flex-col items-center mx-auto w-3/4 mb-12">
      ...
      <div className="">
        <div className="mt-6">
          <p>
             You can either register as a property owner or a tenant. The property owner can post their
            property and manage their tenants. The tenant can find properties to rent.
          </p>
        </div>
